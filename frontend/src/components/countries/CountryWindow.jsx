      ...
      >
        <div className="window-titlebar leather">
          ...
          <div className="titlebar-right">
            <button
              className={`titlebar-button brass-rivet ${
                !showAddForm ? 'active' : ''
              }`}
            ...
            <button
              className="titlebar-button window-minimize brass-rivet"
              onClick={onMinimize}
              title="Minimize"
            >
              🗕
            ...
            <button
              className={`titlebar-button window-maximize brass-rivet ${
                isMaximized ? 'active' : ''
              }`}
            ...
            <button
              className="titlebar-button window-close brass-rivet"
              onClick={onClose}
            >
              🗙
            </button>
